...
const CommunitySection = () => {
  ...
  return (
    <section id="community" className="py-10 sm:py-12 md:py-14 lg:py-16 px-4 md:px-6 w-full transition-colors duration-300">
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 md:gap-12">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-white px-4 lg:px-0">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 leading-relaxed px-4 lg:px-0 hidden">

            </p>

            <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl sm:rounded-2xl p-5 sm:p-6 mb-6 sm:mb-8 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50">
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-white">What You Get:</h3>
              <ul className="space-y-3 sm:space-y-4 text-left">
                {benefits.map((benefit, index) => {
                  const IconComponent = benefit.icon;
                  return (
                    <li key={index} className="flex items-start">
                      <div className="flex-shrink-0 h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center mt-0.5 sm:mt-1">
                        <IconComponent className="text-emerald-600 dark:text-emerald-400" size={14} />
                      </div>
                      <p className="ml-3 sm:ml-4 text-gray-700 dark:text-gray-300 text-sm sm:text-base">
