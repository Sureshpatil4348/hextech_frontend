...
const WhySystemWorks = () => {
  ...
  return (
    <section id="features" className="py-16 md:py-20 px-4 md:px-6 bg-gray-50 dark:bg-gray-900 w-full transition-colors duration-300" style={{fontFamily: 'Pier Sans, sans-serif'}}>
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 justify-items-center">
          {systemFeatures.map((feature) => (
            <div key={feature.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-gray-900/50 p-6 feature-card hover:shadow-xl dark:hover:shadow-gray-900/70 transition-all duration-300 border border-gray-200 dark:border-gray-700">
