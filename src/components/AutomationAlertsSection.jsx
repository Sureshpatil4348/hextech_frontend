      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center px-4 py-1 rounded-full bg-white/20 dark:bg-gray-900/20 backdrop-blur border border-white/40 dark:border-gray-700/40 shadow-lg text-sm font-medium text-[#19235d] dark:text-gray-200" style={{ fontFamily: 'Pier Sans, sans-serif' }}>
            ...
            <p className="text-lg text-[#19235d]/80 dark:text-gray-300 leading-relaxed" style={{ fontFamily: 'Pier Sans, sans-serif' }}>
            ...
            <ul className="space-y-4 text-[#19235d]/80 dark:text-gray-200" style={{ fontFamily: 'Pier Sans, sans-serif' }}>
              <li className="flex items-start">
                <MailCheck className="w-5 h-5 mt-0.5 mr-3 text-emerald-500" />
                <span>High-impact news, indicator confluence and volatility alerts delivered to email, SMS and webhook.</span>
              </li>
              <li className="flex items-start">
                <Inbox className="w-5 h-5 mt-0.5 mr-3 text-emerald-500" />
                <span>Custom routing by asset class or session so your team receives only what matters.</span>
              </li>
              <li className="flex items-start">
                <Server className="w-5 h-5 mt-0.5 mr-3 text-emerald-500" />
                <span>Secure Dubai-hosted infrastructure with redundancy for uninterrupted monitoring.</span>
              </li>
            </ul>
          </div>
